...
import { register, login, logout, getMe, updateProfile, sendVerificationEmailController, sendVerificationSuccessController, registerPrimeVendor } from '../controllers/authController';
