...
import { generalLimiter, authLimiter, searchLimiter } from './middlewares/rateLimiter';
...
import animalAdRoutes from './routes/animalAds';
...
import quickShopRoutes from './routes/quickShop';
...
app.use('/api/product-notifications', generalLimiter, productNotificationRoutes);
...
app.use('/api/courier', generalLimiter, courierRoutes);
app.use('/api/categories', generalLimiter, categoryRoutes);
app.use('/api/brands', generalLimiter, brandRoutes);
app.use('/api/hero-banners', generalLimiter, heroBannerRoutes);
app.use('/api/animal-ads', generalLimiter, animalAdRoutes);
app.use('/api/ads', generalLimiter, adsRoutes);
app.use('/api/vendor-product-pricing', generalLimiter, vendorProductPricingRoutes);
...
app.use('/api/warehouse', generalLimiter, warehouseRoutes);
app.use('/api/warehouse-fulfiller', generalLimiter, warehouseFulfillerRoutes);
app.use('/api/my-shop-vendor', generalLimiter, myShopVendorRoutes);
app.use('/api/quick', generalLimiter, quickShopRoutes);
app.use('/api/prime-vendor', generalLimiter, primeVendorRoutes);
app.use('/api/prime-products', generalLimiter, primeProductRoutes);
